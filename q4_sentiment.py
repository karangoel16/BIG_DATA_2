...
### YOUR CODE HERE
#we wanted to try different regularization and then use this regularization to solve the problem of over fitting
REGULARIZATION = np.logspace(-6,0.1,30)
...
BEST_WEIGHTS = bestResult['weights']
### END YOUR CODE
